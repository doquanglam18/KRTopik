...
{
    public class KoreaBlogConfiguration : IEntityTypeConfiguration<KoreaBlog>
    {
        public void Configure(EntityTypeBuilder<KoreaBlog> builder)
        {
            builder.ToTable("KoreaBlog");
            builder.HasKey(x => x.Id);
            builder.Property(x => x.Id).ValueGeneratedOnAdd();
            builder.Property(x => x.Title).IsRequired();
            builder.Property(x => x.TitleVietSub).IsRequired();
            builder.Property(x => x.Content).IsRequired();
            builder.Property(x => x.VietSubContent).IsRequired();
            ...
            builder.HasData(new KoreaBlog
            {
                ...
                View = 190,
                CreateadBy = new Guid("33333333-3333-3333-3333-333333333333"),
                IsActive = true
            },
            new KoreaBlog
            {
            ...
            new KoreaBlog
            {
                ...
                CreateadBy = new Guid("5C0C563B-80D4-4485-9854-F6AF58422601"), 
                IsActive = true
