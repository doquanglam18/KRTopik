...
{
    /// <inheritdoc />
    public partial class init110520250917 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ListeningSoundURL = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Câu hỏi về ngữ pháp", "Đọc Topik II 1 - 4", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Xem tranh quảng cáo và chọn đáp án đúng", "Đọc Topik II 5 - 8", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Xem biểu đồ, đọc bài để chọn đáp án đúng", "Đọc Topik II 9 - 12", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Sắp xếp thứ tự câu cho đúng", "Đọc Topik II 13 - 15", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Chọn từ thích hợp để điền vào chỗ trống", "Đọc Topik II 16 - 20", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 6, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Đọc và chọn đáp án đúng", "Đọc Topik II 21 - 24", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 7, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Đọc đề mục tin tức và chọn đáp án giải thích đúng nhất", "Đọc Topik II 25 - 27", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 8, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Chọn câu phù hợp vào điền vào chỗ trống", "Đọc Topik II 28 - 31", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 9, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Điền nội dung đúng với đọan văn", "Đọc Topik II 32 - 34", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 10, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Chọn đáp án là nội dung chính của đoạn văn", "Đọc Topik II 35 - 38", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 11, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Chọn vị trí phù hợp để điền câu có sẵn vào", "Đọc Topik II 39 - 41", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 12, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Đọc đoạn văn dài và chọn đáp án phù hợp", "Đọc Topik II 42 - 50", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 13, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Nghe và chọn tranh đúng", "Nghe Topik II 1 - 3", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 14, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Chọn câu tiếp nối cho đoạn hội thoại", "Nghe Topik II 4 - 8", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 15, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Nghe và chọn hành động người nữ hoặc nam sẽ làm tiếp theo", "Nghe Topik II 9 - 12", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 16, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Nghe và chọn đáp án đúng", "Nghe Topik II 13 - 16", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 17, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Nghe và chọn suy nghĩ trọng tâm của nhân vật", "Nghe Topik II 17 - 20", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 18, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Nghe đoạn văn và chọn đáp án đúng (Gồm những đoạn văn dài và khó mức 1)", "Nghe Topik II 21 - 30", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 19, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Nghe đoạn văn và chọn đáp án đúng (Gồm những đoạn văn dài và khó mức 2)", "Nghe Topik II 31 - 50", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 20, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Nội dung nghe đề Topik I", "Nghe Topik I", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 21, new DateTime(2025, 5, 11, 2, 17, 18, 221, DateTimeKind.Utc).AddTicks(4225), "Nội dung đọc đề Topik I", "Đọc Topik I", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(7136), "SystemAdmin", new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(7136) },
                    { 2, new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(7138), "Admin", new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(7138) },
                    { 3, new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(7139), "User", new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(7139) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("5c0c563b-80d4-4485-9854-f6af58422601"), new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(3396), true, "(   )에 들어갈 가장 알맞은 것을 고르십시오. <br>나는 오래전에 설악산을 (       ).", 1, null, null, new Guid("5c0c563b-80d4-4485-9854-f6af58422601"), new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(3397) },
                    { 2, new Guid("5c0c563b-80d4-4485-9854-f6af58422601"), new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(3400), true, "(   )에 들어갈 가장 알맞은 것을 고르십시오. <br>새집으로 (       ) 가구를 새로 샀다.", 1, null, null, new Guid("5c0c563b-80d4-4485-9854-f6af58422601"), new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(3400) },
                    { 3, new Guid("5c0c563b-80d4-4485-9854-f6af58422601"), new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(3402), true, "다음 밑줄 친 부분과 의미가 비슷한 것을 고르십시오.<br>어려운 이웃을 <u>돕고자</u> 매년 봉사 활동에 참여하고 있다.", 1, null, null, new Guid("5c0c563b-80d4-4485-9854-f6af58422601"), new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(3403) },
                    { 4, new Guid("5c0c563b-80d4-4485-9854-f6af58422601"), new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(3405), true, "다음 밑줄 친 부분과 의미가 비슷한 것을 고르십시오.<br>지난 3년 동안 영화를 한 편 봤으니 거의 안 본 <u>셈이다</u>.", 1, null, null, new Guid("5c0c563b-80d4-4485-9854-f6af58422601"), new DateTime(2025, 5, 11, 2, 17, 18, 223, DateTimeKind.Utc).AddTicks(3406) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "등산하고 싶다", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6015), false, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "등산해도 된다 ", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6024), false, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, "등산할 것 같다", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6025), false, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, "등산한 적이 있다", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6026), true, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, "이사한 지", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6027), false, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 6, "이사하거든", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6029), false, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 7, "이사하려면 ", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6030), false, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 8, "이사하고 나서 ", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6031), true, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 9, "돕기 위해서", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6033), true, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 10, "돕는 대신에", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6034), false, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 11, "돕기 무섭게", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6035), false, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 12, "돕는 바람에 ", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6036), false, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 13, "본 척했다", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6048), false, 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 14, "보기 나름이다", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6053), false, 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 15, "보기 나름이다", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6054), false, 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 16, "본 거나 마찬가지이다", new DateTime(2025, 5, 11, 9, 17, 18, 223, DateTimeKind.Local).AddTicks(6055), true, 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
